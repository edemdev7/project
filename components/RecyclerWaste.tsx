...
import { View, Text, StyleSheet, FlatList, Image, TouchableOpacity, Modal, ActivityIndicator, Alert } from 'react-native';
          ...
          {selectedWaste && (
            <View style={styles.wasteInfo}>
              <Text style={styles.wasteInfoTitle}>
                {selectedWaste.wasteType.charAt(0).toUpperCase() + selectedWaste.wasteType.slice(1)} - {selectedWaste.weight} kg
              </Text>
    ...
    <View style={styles.container}>
      ...
      {wasteList.length === 0 ? (
        <View style={styles.emptyContainer}>
          <Text style={styles.emptyText}>Aucun déchet disponible actuellement.</Text>
        </View>
      ) : (
        <FlatList
          data={wasteList}
